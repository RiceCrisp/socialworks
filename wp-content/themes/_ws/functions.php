...
function _ws_setup() {
  ...
  register_nav_menus([
    'header-primary' => __('Primary Header', '_ws'),
    'header-secondary' => __('Secondary Header', '_ws')
  ]);
...
function _ws_register_widget_areas() {
  ...
  //   'name' => __('Sidebar', '_ws'),
  //   'id' => 'sidebar',
  //   'description' => __('Widgets in this area will appear on pages with a left or right sidebar', '_ws')
  // ]);
  register_sidebar([
    'name' => __('Footer', '_ws'),
    'id' => 'footer',
    'description' => __('Widgets in this area will appear in the footer', '_ws')
  ]);
  register_sidebar([
    'name' => __('Sub Footer', '_ws'),
    'id' => 'sub-footer',
    'description' => __('Widgets in this area will appear below the footer', '_ws')
  ]);
}
