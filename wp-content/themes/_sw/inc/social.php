<?php
// Fill meta box
function _sw_social_meta_fields() {
...
// Create meta box
function _sw_social_meta() {
  add_meta_box('social-meta-box', 'Social', '_sw_social_meta_fields', get_post_types(), 'normal', 'high');
}
add_action('add_meta_boxes', '_sw_social_meta');

// Save meta values
function _sw_save_social_meta($post_id) {
...
add_action('save_post', '_sw_save_social_meta');
