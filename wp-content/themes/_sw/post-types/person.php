...
add_action('init', '_sw_person_post_type');

// Fill meta box
function _sw_person_meta_fields() {
...
// Create meta box
function _sw_person_meta() {
  add_meta_box('person_meta', 'Person', '_sw_person_meta_fields', 'person', 'normal', 'high');
}
add_action('admin_init', '_sw_person_meta');

// Save meta values
function _sw_save_person_meta($post_id) {
...
add_action('save_post', '_sw_save_person_meta');
