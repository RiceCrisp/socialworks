...
function _sw_testimonial_post_type() {
  $labels = array(
    'name' => 'Testimonial',
...
add_action('init', '_sw_testimonial_post_type');

// Fill meta box
function _sw_testimonial_meta_fields() {
...
// Create meta box
function _sw_testimonial_meta() {
  add_meta_box('testimonial_meta', 'Testimonial', '_sw_testimonial_meta_fields', 'testimonial', 'normal', 'high');
}
add_action('admin_init', '_sw_testimonial_meta');

// Save meta values
function _sw_save_testimonial_meta($post_id) {
...
add_action('save_post', '_sw_save_testimonial_meta');
